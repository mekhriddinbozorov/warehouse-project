...
public partial class ProductsController : ControllerBase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (files.Count > 5 || files.Count + product.ProductMedia.Count > 5)
        ...
        var values = product.ProductMedia.Select(m => new GetProductMediumDto(m)
        {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return Ok(product.ProductMedia.Select(u => new GetProductMediumDto(u)
        {
